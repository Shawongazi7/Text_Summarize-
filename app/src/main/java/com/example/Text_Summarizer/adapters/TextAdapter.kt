...
class TextAdapter : ListAdapter<Text, TextAdapter.TextViewHolder>(TextDiffCallback()) {
...
//        private val deleteButton: ImageButton = itemView.findViewById(R.id.iv_delete_card)
